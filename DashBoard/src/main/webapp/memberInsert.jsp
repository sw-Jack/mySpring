		...
		<div class="container-fluid">
			<div class="row mb-5">
				<div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
					<div>
						<button type="button" class="btn btn-info btn-sm" onclick="acyncMovePage('manage_member.jsp')">뒤로가기</button>
													...
													<div class="card-body">
														<div class="d-flex">
															<div class="text-left text-secondary">	
																...
																<div>
																	<button type="button" class="btn btn-success btn-sm" onclick="acyncMovePage('manage_member.jsp')">등록하기</button>
																	<button type="button" class="btn btn-danger btn-sm" onclick="acyncMovePage('manage_member.jsp')">뒤로가기</button>
																</div>
															</div>
														</div>
